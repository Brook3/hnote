# 1. shell自动安装
脚本安装
参照 https://laravel-china.org/topics/2814/ubuntu-1416-under-the-laravel-lnmp-online-environment-automatically-deploy-scripts 中的
https://raw.githubusercontent.com/summerblue/laravel-ubuntu-init/master/deploy.sh
这个是ubuntu的示例：之后要改一个centos的，受控到GitHub上的脚本区
